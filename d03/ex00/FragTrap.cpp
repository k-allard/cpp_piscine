...
/*   Updated: 2021/01/09 00:35:10 by kallard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void FragTrap::meleeAttack(std::string const & target) {
	std::cout << "Robot " << _name << " hits " << target;
...
void FragTrap::takeDamage(unsigned int amount) {
	std::cout << "Robot " << _name << " was attacked! ";
...
void FragTrap::beRepaired(unsigned int amount) {
	std::cout << "Robot " << _name << " was repaired 🏥 + " << amount << " HP! ";
	std::cout << "Health : [" <<_hitPoints << " --> ";
	_hitPoints += amount;
...
void FragTrap::sweetAttack(std::string const & target) {
	std::cout << "Robot " << _name << " makes a sweet attack over " << target;
	std::cout << ", causing 25";
	std::cout << " points of damage!" << std::endl;
